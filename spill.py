...
#Verdi som er True når quiz pågår
QuizStart = False

#Sjekker om ledertavlen er synnlig eller ikke
Ledertavle = False
...
#Startskjerm før Quizen Begynner
...
#Hovedfunksjonen som kontrollerer alle andre klasser/funksjoner
def main():
    global QuizStart
    global GlobalTid
    global KlikkLyd
...
#Stoppeklokken Som Teller Ned Når Quizen Pågår
def StopWatch():
    if (QuizStart == True):
        global GlobalTid
...
#Dette Starter 'main()' Funksjonen Som Vil Begyne Programmet
